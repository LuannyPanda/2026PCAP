# Fliperama da Luanny.Panda

Um fliperama de terminal com três jogos, placar que não esquece e cadastro de jogadores. Projeto da disciplina PCAP, 1 ano Técnico em Informática do IFPR.
...
- 'adivinhe.py', 'ppt.py', 'par_impar' - um arquivo por jogo
- 'placar.csv' e 'jogadores.csv' - os dados, que nascem sozinhos

A função 'ler_texto' ficou no 'modulos.py' porque
